...
abstract class BaseController
{
    ...
    protected $inputMethod; //how to assemble data from DB
    protected $outputMethod; //how to plug a view
    ...
    public function route(){
        ...
        try{
            //создаем объект класса рефлектметод, проверяем в его конструкторе есть ли метод реквест в классе контроллер
            ...
            $object->invoke(new $controller, $args); //в объекте лежит объект класса рефлект, через него вызываем объект контроллера, у него будет попытка вызова метода реквест с аргументами из инвока
